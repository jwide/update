...
if [ "$#" -ne 10 ]; then
    ...
    echo " "
    echo " /bin/sh updateips.sh 192.168.0.7 22 192.168.4.7 22 192.168.4.1 192.168.0.1 192.168.0.0 24 192.168.0.64 26 192.168.0.9 192.168.0.11 172.31.168.0 24 192.168.0.0 24"
    echo " "
    exit 1
else
